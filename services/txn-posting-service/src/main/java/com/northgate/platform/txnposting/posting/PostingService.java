package com.northgate.platform.txnposting.posting;

import com.northgate.platform.common.correlation.CorrelationId;
import com.northgate.platform.common.error.ApiException;
import com.northgate.platform.txnposting.bedrock.BedrockAdapterClient;
import com.northgate.platform.txnposting.bedrock.BedrockPostingResult;
...
public class PostingService {
    ...
    public PostingService(PostingRepository repository, PostingValidator validator, BedrockAdapterClient bedrock,
                          @Value("${northgate.posting.hold-when-bedrock-unavailable:true}") boolean holdWhenUnavailable,
                          @Value("${northgate.posting.reversal-window-days:60}") int reversalWindowDays) {
