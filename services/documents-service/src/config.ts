...
export const config = {
  ...
  authMode: env('NORTHGATE_AUTH_MODE', 'jwks') as 'jwks' | 'insecure-local',
  ...
  keystoneAudiences: env('KEYSTONE_AUDIENCES', 'api://northgate-digital-channels,northgate-retail,northgate-business').split(','),
  ...
  /**
   * Object store. In the bank this is the on-prem S3 compatible appliance (bucket northgate-docs-prod,
