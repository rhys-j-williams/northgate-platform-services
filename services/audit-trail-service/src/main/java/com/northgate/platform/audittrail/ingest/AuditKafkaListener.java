package com.northgate.platform.audittrail.ingest;
...
public class AuditKafkaListener {
    ...
    @KafkaListener(topics = "${northgate.audit.topics.envelope:audit.events.v1}", autoStartup = "${northgate.audit.consume:true}")
    ...
    @KafkaListener(topics = "${northgate.audit.topics.preferences:alerts.preferences.changed.v1}",
        autoStartup = "${northgate.audit.consume:true}")
