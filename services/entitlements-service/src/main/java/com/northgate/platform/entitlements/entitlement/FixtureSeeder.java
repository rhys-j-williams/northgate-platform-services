package com.northgate.platform.entitlements.entitlement;
...
/**
 * Seeds ENTITLEMENT from platform-services/fixtures/northgate-fixtures.json when the table is empty.
 * Same lookup order as common-starter's FixtureStore (property, NORTHGATE_FIXTURES, ../../fixtures).
...
public class FixtureSeeder implements ApplicationRunner {
    ...
    public FixtureSeeder(EntitlementRepository repository, @Value("${northgate.fixtures.path:}") String configuredPath) {
    ...
    private JsonNode locate() {
        ...
        candidates.add("../../fixtures/northgate-fixtures.json");
        candidates.add("../../../fixtures/northgate-fixtures.json");
