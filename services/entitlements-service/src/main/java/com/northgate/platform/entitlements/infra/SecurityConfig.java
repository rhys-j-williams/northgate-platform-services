...
/**
 * Resource server against Keystone. northgate.security.enabled=false is for tests and for the
...
public class SecurityConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "northgate.security", name = "enabled", havingValue = "true", matchIfMissing = true)
