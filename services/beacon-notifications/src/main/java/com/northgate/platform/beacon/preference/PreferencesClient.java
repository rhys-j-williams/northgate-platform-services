package com.northgate.platform.beacon.preference;
...
public class PreferencesClient {
    ...
    public PreferencesClient(RestTemplateBuilder builder, FixtureStore fixtures,
                             @Value("${northgate.beacon.preferences-url:http://localhost:4511/preferences/v1}") String baseUrl,
                             @Value("${northgate.beacon.fixture-fallback:true}") boolean fixtureFallback) {
