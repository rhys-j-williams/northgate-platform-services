...
Owner: @meridian/payments-platform. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@meridian.internal`) with the component name `platform-services` and, if the finding came
