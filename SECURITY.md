# Application security standard — Platform services

Owner: @northgate/payments-platform. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@northgate.internal`) with the component name `platform-services` and, if the finding came
